...
@section('title', __('setting.General Settings'))
...
<div class="container py-3">
  ...
  <nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb mb-0">
      <li class="breadcrumb-item"><a href="{{ route('settings.index') }}">@lang('setting.General Settings')</a></li>
      <li class="breadcrumb-item active" aria-current="page">@lang('setting.View')</li>
    </ol>
  </nav>
  ...
  <div class="d-flex align-items-center justify-content-between mb-3">
    <div class="d-flex align-items-center gap-3">
      ...
      <div>
        ...
        <small class="text-muted">@lang('setting.Details of the general system setting')</small>
      </div>
    </div>
  ...
  <div class="row g-3">
    ...
    <div class="col-lg-7">
      <div class="card shadow-sm h-100">
        <div class="card-body mt-2">
          <h6 class="mb-3">@lang('setting.Basic Data')</h6>
    ...
    <div class="col-lg-5">
      <div class="card shadow-sm h-100">
        <div class="card-body mt-2">
          <h6 class="mb-3">@lang('setting.Previews')</h6>

          {{-- Logo Preview --}}
          <div class="mb-4">
            <div class="d-flex align-items-center justify-content-between mb-2">
              <span class="text-muted">@lang('setting.Logo')</span>
              @if(!empty($setting->logo_url))
                <a href="{{ $setting->logo_url }}" target="_blank" class="small">@lang('setting.Open Original')</a>
              @endif
            </div>
            @if(!empty($setting->logo_url))
            ...
            @else
              <div class="border rounded p-3 bg-light d-flex align-items-center justify-content-center" style="min-height:90px;">
                <span class="text-muted fst-italic">@lang('setting.No logo uploaded')</span>
              </div>
            @endif
          </div>
          ...
          <div>
            <div class="d-flex align-items-center justify-content-between mb-2">
              ...
              @if(!empty($setting->favicon_url))
                <a href="{{ $setting->favicon_url }}" target="_blank" class="small">@lang('setting.Open Original')</a>
              @endif
            </div>
            @if(!empty($setting->favicon_url))
              <div class="d-flex align-items-center gap-3">
                ...
                <div class="text-muted small">@lang('setting.Default preview for icon size')</div>
              </div>
            @else
              <div class="border rounded p-3 bg-light d-flex align-items-center justify-content-center" style="min-height:64px;">
                <span class="text-muted fst-italic">@lang('setting.No icon uploaded')</span>
              </div>
            @endif
          </div>
          ...
          <hr class="my-4">
          <div>
            <div class="text-muted small mb-2">@lang('setting.Inline Preview')</div>
