          ...
          <form method="POST" action="{{ route('settings.update', $setting) }}" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-md-6">
              <label class="form-label d-flex justify-content-between">
                <span>@lang('setting.Logo (PNG/JPG/WEBP/SVG)')</span>
                @if(!empty($setting->logo_url))
                  <a href="{{ $setting->logo_url }}" target="_blank" class="small">@lang('setting.View Current')</a>
                @endif
              </label>
              ...
              @if(!empty($setting->logo_url))
                <div class="form-check mt-2">
                  ...
                  <label class="form-check-label" for="remove_logo">@lang('setting.Delete current logo')</label>
                </div>
                <div class="mt-2">
            ...
            <div class="col-md-6">
              <label class="form-label d-flex justify-content-between">
                <span>@lang('setting.Favicon (ICO/PNG/JPG/WEBP/SVG)')</span>
                @if(!empty($setting->favicon_url))
                  <a href="{{ $setting->favicon_url }}" target="_blank" class="small">@lang('setting.View Current')</a>
                @endif
              </label>
              ...
              @if(!empty($setting->favicon_url))
                <div class="form-check mt-2">
                  ...
                  <label class="form-check-label" for="remove_favicon">@lang('setting.Delete current icon')</label>
                </div>
                <div class="mt-2">
