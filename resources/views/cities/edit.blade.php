  ...
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('cities.Edit City')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('cities.update', $item) }}" class="row g-3">
          ...
          <div class="col-12 form-check">
            ...
            <label class="form-check-label" for="is_active">@lang('cities.Active')</label>
          </div>
