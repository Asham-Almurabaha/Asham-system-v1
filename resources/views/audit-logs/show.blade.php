...
<div class="container py-3" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
  <nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb mb-0">
      <li class="breadcrumb-item"><a href="{{ route('audit-logs.index') }}">@lang('audit.Audit Logs')</a></li>
  ...
  <div class="d-flex align-items-center justify-content-between mb-3">
    <div>
      <h4 class="mb-0">@lang('audit.Log Details')</h4>
  ...
  <div class="row g-3">
    <div class="col-lg-5">
      <div class="card shadow-sm h-100">
        <div class="card-body mt-2">
          <h6 class="mb-3">@lang('audit.Summary')</h6>
          <div class="table-responsive">
            <table class="table table-sm align-middle mb-0">
              <tbody>
                <tr>
                  <th style="width:200px">@lang('audit.Table')</th>
    ...
    <div class="col-lg-7">
      <div class="card shadow-sm h-100">
        <div class="card-body mt-2">
          <h6 class="mb-3">@lang('audit.Changes')</h6>
          <div class="row g-3">
            <div class="col-md-6">
              <div>
                <div class="text-muted small mb-1">@lang('audit.Old Values')</div>
                <pre class="bg-light border rounded p-2 small mb-0">@json($auditLog->old_values, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT)</pre>
              </div>
            </div>
            <div class="col-md-6">
              <div>
                <div class="text-muted small mb-1">@lang('audit.New Values')</div>
