<form method="POST" action="{{ route('phones.assignments.store', $phone) }}" class="row g-3 mb-4">
  @csrf
  <div class="col-md-4">
    <label class="form-label">@lang('phones::assignments.Employee')</label>
  ...
  <div class="col-md-4">
    <label class="form-label">@lang('phones::assignments.Condition On Assign')</label>
  ...
  <div class="col-md-4">
    <label class="form-label">@lang('phones::assignments.Document Number')</label>
    <input type="text" name="document_number" class="form-control @error('document_number') is-invalid @enderror">
    @error('document_number')<div class="invalid-feedback">{{ $message }}</div>@enderror
  </div>
  <div class="col-12">
    <x-btn type="submit" variant="primary" icon="bi bi-check2">@lang('phones::assignments.Assign')</x-btn>
  </div>
</form>
