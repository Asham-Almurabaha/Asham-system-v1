...
@section('title', __('org::departments.Create Department'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('org::departments.Create Department')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('departments.store') }}" class="row g-3">
          ...
          <div class="col-12 form-check">
            ...
            <label class="form-check-label" for="is_active">@lang('org::departments.Active')</label>
          </div>
