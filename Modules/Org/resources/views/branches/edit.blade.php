...
@section('title', __('org::branches.Edit Branch'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('org::branches.Edit Branch')</h5>
        <x-btn href="{{ route('branches.index') }}" size="sm" variant="outline-secondary" icon="bi bi-arrow-right-circle">@lang('org::branches.Back')</x-btn>
      </div>
      <div class="card-body">
        <form method="POST" action="{{ route('branches.update', $item) }}" class="row g-3">
          ...
          @method('PUT')
          <div class="col-md-6">
            <label class="form-label">@lang('org::branches.Company')</label>
          ...
          <div class="col-md-6">
            ...
            <select name="city_id" class="form-select @error('city_id') is-invalid @enderror">
              <option value="">--</option>
              @foreach($cities as $c)
                <option value="{{ $c->id }}" @selected(old('city_id', $item->city_id)==$c->id)>{{ $c->name_en }}</option>
              @endforeach
            </select>
          ...
          <div class="col-md-6">
            <label class="form-label">@lang('org::branches.Name (AR)')</label>
          ...
          <div class="col-12 form-check">
            ...
            <label class="form-check-label" for="is_active">@lang('org::branches.Active')</label>
          </div>
