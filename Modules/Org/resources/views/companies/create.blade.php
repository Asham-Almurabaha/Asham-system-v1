...
@section('title', __('org::companies.Create Company'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('org::companies.Create Company')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('companies.store') }}" class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="cr_number" class="form-control @error('cr_number') is-invalid @enderror" value="{{ old('cr_number') }}">
