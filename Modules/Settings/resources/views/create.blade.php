...
@section('title', __('settings::setting.Create Setting'))
    ...
    <div class="col-lg-8 mx-auto">
      <div class="card shadow-sm">
        <div class="card-header">
          <h5 class="mb-0">@lang('settings::setting.Create Setting')</h5>
        </div>
        <div class="card-body">
          <form method="POST" action="{{ route('settings.store') }}" enctype="multipart/form-data" class="row g-3">
            ...
            {{-- Logo --}}
            <div class="col-md-6">
              <label class="form-label">@lang('settings::setting.Logo (PNG/JPG/WEBP/SVG)')</label>
              <input type="file"
                     name="logo"
            ...
            {{-- Favicon --}}
            <div class="col-md-6">
              <label class="form-label">@lang('settings::setting.Favicon (ICO/PNG/JPG/WEBP/SVG)')</label>
              <input type="file"
                     name="favicon"
