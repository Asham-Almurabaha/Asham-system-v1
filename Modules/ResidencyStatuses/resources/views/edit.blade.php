...
@section('title', __('residencystatuses::residencystatuses.Edit Residency Status'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('residencystatuses::residencystatuses.Edit Residency Status')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('residency-statuses.update', $item) }}" class="row g-3">
          @csrf
          @method('PUT')
          <div class="col-md-6">
