...
<div class="container py-3">
  <nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb mb-0">
      ...
      <li class="breadcrumb-item"><a href="{{ route('titles.index') }}">@lang('titles::titles.Job Titles')</a></li>
      <li class="breadcrumb-item active" aria-current="page">@lang('titles::titles.View Title')</li>
    </ol>
  </nav>
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('titles::titles.View Title')</h5>
        <div class="d-flex gap-2">
          <x-btn href="{{ route('titles.edit', $item) }}" variant="primary" size="sm" icon="bi bi-pencil">@lang('titles::titles.Edit')</x-btn>
