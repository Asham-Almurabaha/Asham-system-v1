...
@section('title', __('employees::residencystatuses.View Residency Status'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('employees::residencystatuses.View Residency Status')</h5>
      ...
      <div class="card-body">
        <div class="row mb-3">
          <div class="col-md-6">
            <strong>@lang('employees::residencystatuses.Name (EN)'):</strong> {{ $item->name_en }}
          </div>
          <div class="col-md-6">
            <strong>@lang('employees::residencystatuses.Name (AR)'):</strong> {{ $item->name_ar }}
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <strong>@lang('employees::residencystatuses.Active'):</strong>
            @if($item->is_active)
