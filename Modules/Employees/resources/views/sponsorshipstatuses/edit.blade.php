...
@section('title', __('employees::sponsorshipstatuses.Edit Sponsorship Status'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('employees::sponsorshipstatuses.Edit Sponsorship Status')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('sponsorship-statuses.update', $item) }}" class="row g-3">
          @csrf
          @method('PUT')
          <div class="col-md-6">
            <label class="form-label">@lang('employees::sponsorshipstatuses.Name (EN)')</label>
          ...
          <div class="col-md-6">
            <label class="form-label">@lang('employees::sponsorshipstatuses.Name (AR)')</label>
          ...
          <div class="col-12 form-check">
            ...
            <label class="form-check-label" for="is_active">@lang('employees::sponsorshipstatuses.Active')</label>
          </div>
          <div class="col-12 d-flex gap-2">
            <x-btn variant="outline-success" type="submit" icon="bi bi-check2">@lang('users.Save')</x-btn>
            <x-btn href="{{ route('sponsorship-statuses.index') }}" variant="outline-secondary">@lang('users.Cancel')</x-btn>
          </div>
        </form>
      </div>
    </div>
