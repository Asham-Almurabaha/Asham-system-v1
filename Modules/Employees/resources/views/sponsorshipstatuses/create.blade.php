...
@section('title', __('employees::sponsorshipstatuses.Create Sponsorship Status'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('employees::sponsorshipstatuses.Create Sponsorship Status')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('sponsorship-statuses.store') }}" class="row g-3">
          @csrf
          <div class="col-md-6">
