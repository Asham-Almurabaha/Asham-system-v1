...
@section('title', __('cars::years.Create Car Year'))
@section('content')
<div class="container py-3">
  <div class="col-lg-6 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('cars::years.Create Car Year')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('car-years.store') }}" class="row g-3">
          @csrf
          <div class="col-md-6">
