...
@section('title', __('cars::violation-types.Create Violation Type'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('cars::violation-types.Create Violation Type')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('violation-types.store') }}" class="row g-3">
          @csrf
          <div class="col-md-6">
