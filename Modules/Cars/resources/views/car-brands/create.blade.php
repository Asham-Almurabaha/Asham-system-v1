...
@section('title', __('cars::brands.Create Car Brand'))
@section('content')
<div class="container py-3">
  <div class="col-lg-8 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('cars::brands.Create Car Brand')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('car-brands.store') }}" class="row g-3">
          @csrf
          <div class="col-md-6">
