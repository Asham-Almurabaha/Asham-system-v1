...
@section('title', __('cars::cars.Edit Car'))
@section('content')
<div class="container py-3" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
  <nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb mb-0">
      <li class="breadcrumb-item"><a href="{{ route('cars.index') }}">@lang('cars::cars.Cars')</a></li>
      <li class="breadcrumb-item active" aria-current="page">@lang('cars::cars.Edit Car')</li>
    </ol>
  </nav>
  <div class="col-lg-10 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">@lang('cars::cars.Edit Car')</h5>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('cars.update', $car) }}" class="row g-3">
          ...
          <div class="col-12 d-flex gap-2">
            <x-btn variant="outline-primary" type="submit" icon="bi bi-check2">@lang('cars::common.Save')</x-btn>
