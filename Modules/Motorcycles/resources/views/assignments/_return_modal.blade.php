  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">@lang('motorcycles::assignments.Return')</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form method="POST" action="{{ route('motorcycles.assignments.return', [$motorcycle, $motorcycle->currentAssignment]) }}" class="row g-3">
        @csrf
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label class="form-label">@lang('motorcycles::assignments.Condition On Return')</label>
        ...
        <div class="modal-footer">
          <x-btn type="submit" variant="outline-warning" icon="bi bi-check2">@lang('motorcycles::assignments.Return')</x-btn>
        </div>
      </form>
    </div>
  </div>
